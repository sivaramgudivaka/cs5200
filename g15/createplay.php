...
<div style="position:absolute;top:11%;left:6cm;">
  <table align="center" cellpadding="6" cellspacing="8" border="0">
	 <form name="play_form" method="post" action="servercreateplaylist.php">
		<tr>
		<td>Playlist Name:</a></td>
		<td><input type="text" class="textBox" name="plname" required autofocus></td>
		</tr>
		<tr>
		<td><input type="submit" id="btn" value="Create"></td>			
		</tr>
