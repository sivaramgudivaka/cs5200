...
<div style="position:absolute;top:11%;left:6cm;">
  <table align="center" cellpadding="6" cellspacing="8" border="0">
		...
		<tr>
		<td><a href="createplay.php" class="auth_opt">Create Playlist</a></td>
		<td>click this button to create a New Playlist</td>
		</tr>
		<tr class="display_style">
		<td><b>My Playlists</b></td>	
		...
		$res = $plst_dao->get_playlist_name($plst_obj);
		while($row=mysqli_fetch_array($res))
		{
			$pname=$row['Pname'];
			$url="displaylists.php?n=".$pname;
			echo "<tr class=\"display_style\"><td><a class=\"auth_opt\" href=\"".$url."\">".$pname."</a></td></tr>";
		}
		?>
